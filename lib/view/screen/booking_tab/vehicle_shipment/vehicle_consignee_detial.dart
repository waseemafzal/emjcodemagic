...
// class VehicleConsigneeDetail extends StatefulWidget {
//   const VehicleConsigneeDetail({super.key});

//   @override
//   State<VehicleConsigneeDetail> createState() => _VehicleConsigneeDetailState();
// }

// class _VehicleConsigneeDetailState extends State<VehicleConsigneeDetail> {
...
import 'package:emjay_global/view/screen/booking_tab/vehicle_shipment/calculate_vehicle_rate.dart';
import 'package:emjay_global/view/widgets/my_custom_button.dart';
import 'package:emjay_global/view/widgets/my_custom_text_box.dart';
import 'package:flutter/material.dart';
...
class _VehicleConsigneeDetailState extends State<VehicleConsigneeDetail> {
  ...
  Widget build(BuildContext context) {
    print(widget.myDescriptionList);
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Book",
          ...
          if (_formKey.currentState!.validate() &&
            ...
            Get.to(
              () => CalculateVehiclePackageRate(
                ...
                myDescriptionList: widget.myDescriptionList,
                myVinnumberList: widget.myVinnumberList,
                myPreferenceCompanyList: widget.myPreferenceCompanyList,
                myPurchaseCostList: widget.myPurchaseCostList,
              ),
            );
